  ...
  pages: [
    {
      ...
      description:
        "OP Delegates are the stewards of the Near Token House, appointed by token holders to make governance decisions on their behalf.",
      hero: optimismHero,
      meta: {
        title: "Near Agora",
    ...
    {
      route: "info",
      title: "Welcome to the Near Collective",
      description:
        "A collective of companies, communities, and citizens working together.",
      hero: optimismHero,
      meta: {
        title: "Info of Agora",
        description: "Welcome to the Near Collective",
        imageTitle: "Info of Agora",
        imageDescription: "Welcome to the Near Collective",
      },
      links: [
        {
