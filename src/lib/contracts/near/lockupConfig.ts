...
export const lockupMethodRequirements: MethodRequirementsConfig<LockupWriteContractMethods> =
  {
    ...
    deposit_and_stake: {
      gas: "125", // Requires 125 TGas (5 * BASE_GAS)
      deposit: "1", // Requires exactly 1 yoctoNEAR
    },
    deposit_to_staking_pool: {
      gas: "100", // Requires 100 TGas (4 * BASE_GAS)
      deposit: "1", // Requires exactly 1 yoctoNEAR
    },
    end_unlock_near: {
      deposit: "1", // Requires exactly 1 yoctoNEAR
    ...
    new: {
      gas: "25", // Requires 25 TGas (1 * BASE_GAS)
    },
    ...
    refresh_staking_pool_balance: {
      deposit: "1", // Requires exactly 1 yoctoNEAR
      gas: "75", // Requires 75 TGas (3 * BASE_GAS)
    },
    select_staking_pool: {
      deposit: "1", // Requires exactly 1 yoctoNEAR
      gas: "75", // Requires 75 TGas (3 * BASE_GAS)
    ...
    transfer: {
      deposit: "1", // Requires exactly 1 yoctoNEAR
      gas: "50", // Requires 50 TGas (2 * BASE_GAS)
    },
    ...
    withdraw_all_from_staking_pool: {
      deposit: "1", // Requires exactly 1 yoctoNEAR
      gas: "175", // Requires 175 TGas (7 * BASE_GAS)
    },
